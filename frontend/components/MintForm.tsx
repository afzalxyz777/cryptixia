...
// ✅ Dummy contract details (replace later)
const contractAddress = "0x5dC9a32B375118Cd82452A7140Dc8338A27A0E9C"
const contractABI = [
  {
    "type": "constructor",
    "inputs": [],
...
export default function MintForm() {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      write?.({ recklesslySetUnpreparedArgs: [address, tokenUri] })
    } catch (err) {
      console.error(err)
